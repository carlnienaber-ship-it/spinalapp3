...
const closingTasks: Task[] = [
    ...
    { id: 'close_tabs', text: 'Close all outstanding bar tabs', type: 'toggle_text', completed: false, notes: '' },
    ...
    { id: 'electricity_meter_check_close', text: 'Check prepaid electricity meter', type: 'toggle', completed: false },
