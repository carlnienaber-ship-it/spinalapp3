...
const App: React.FC = () => {
  ...
  const { submitShift } = useApiClient(); 
        ...
        return (
          <div className="text-center">
            ...
            <div className="bg-gray-800 p-8 rounded-lg shadow-lg max-w-md mx-auto">
              ...
              {isAdmin && (
                <Button onClick={() => setAdminShowDashboard(true)} variant="primary" className="mt-4 w-full">
                  Admin Dashboard
                </Button>
              )}
            </div>
        ...
        return (
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="mt-8">
              ...
              <Button onClick={handleSubmit} className="w-full" size="lg" disabled={!shiftState.shiftFeedback.rating || isGeoDisabled}>
